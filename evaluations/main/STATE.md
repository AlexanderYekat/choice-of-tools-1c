...
2026-09-20 → включение фасада только манифестом в репозитории,
не фразой в чате.
2026-09-20 → корневой AGENTS.md сокращён до загрузчика; решения
и история не дублируются в постоянном контексте.

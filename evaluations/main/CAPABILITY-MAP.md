...
| C5 edit | r01 основной; r12 дубль, не в контуре; r17 только EDT | частичное (УФ+метаданные) | c01-facade, c01-apply-fence, c01-apply-dryrun-simple, c12-managed-forms | забор ifRev RUN; dryRun на этой фикстуре `invalid_source` | apply preview на Designer 2.20; ОФ не требуется |
...
1. Execution пяти: индекс выгрузки r15, Unica `view`/`docs`/`apply` dryRun на sample есть;
   публикация apply, Answer42, Vanessa ещё нет.
